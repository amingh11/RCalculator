...
duration_selection = st.radio("Select one duration", duration_options)
...
if duration_selection == "≤7 days":
    calculation += 1 * 0
elif duration_selection == "8-14 days":
    calculation += 1 * 1.283
elif duration_selection == "15-30 days":
    calculation += 1 * 2.187
elif duration_selection == ">30 days":
    calculation += 1 * 2.45
